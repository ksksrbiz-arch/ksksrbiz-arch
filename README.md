<!-- ============================================================
     ...
     Every window below is a self-contained animated SVG in /assets: pure
     CSS/SMIL, no scripts, and no external references of its own — none of
     them pulls in a font, image or stylesheet.

     The page around them does of course make requests: it loads each SVG
     from raw.githubusercontent.com, and embeds four third-party images —
     two stat cards, a visitor counter and a follower badge.

     The repo file manager and the hosting board are generated by the
     scripts in /tools at authoring time, so nothing on this page depends
     on GitHub Actions to render.
     ============================================================ -->
...
<p align="center"><a href="https://tobereadshop.com"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/client-tbr.svg?v=10" alt="tobereadshop.com — To Be Read, the Clackamas Book Exchange in Milwaukie, Oregon: a used bookstore site with browse, trade and events, thousands of titles in store and online sales via PangoBooks and Bookshop.org. Built in Next.js, hosted and deployed by 1COMMERCE" width="24.4%"></a><a href="https://precisioncorebuilders.com"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/client-pcb.svg?v=10" alt="precisioncorebuilders.com — Precision Core Builders of Eugene, Oregon: custom homes, remodels and additions, licensed CCB #246527, with a free on-site estimate call to action. Built in React, hosted and deployed by 1COMMERCE" width="24.4%"></a><a href="https://montuckymoonshine.com"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/client-montucky.svg?v=10" alt="montuckymoonshine.com — a craft spirits storefront: product grid, add to cart and live Shopify checkout. Built on Shopify, hosted and deployed by 1COMMERCE" width="24.4%"></a><a href="https://windowsbyclearview.com"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/client-clearview.svg?v=1" alt="windowsbyclearview.com — Clearview Windows, replacement and new-construction window installation in Vancouver, Washington, WA L&amp;I registered CLEARVW74601: an old pane swapping for a new one, a free-estimate call to action. Built in Astro, hosted and deployed by 1COMMERCE" width="24.4%"></a></p>

<!-- side project spotlight: personal build, not client work -->
<p align="center"><a href="https://walking-dead-universe-atlas.netlify.app/"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/project-atlas.svg?v=1" alt="walking-dead-universe-atlas.netlify.app — The Walking Dead Universe Atlas, a mobile-first data atlas for TWDU: a pulsing community map, series filter chips and a universe-year timeline scrubber over 19 normalized JSON registries. A personal build in React + TypeScript, not client work" width="49.4%"></a></p>

<!-- managed hosting status board (generated by tools/gen_status_board.py) -->
<p align="center"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/os-hosting.svg?v=11" alt="status.1commerce — managed hosting and deployment: the four client sites with their stack, hosting, HTTPS status and live status, over summary tiles for client sites live, HTTPS with HSTS on all of them, and deploy-on-push" width="100%"></p>
...
<!-- REPO-WINDOWS:START -->
<p align="center"><a href="https://github.com/ksksrbiz-arch?tab=repositories"><img src="https://raw.githubusercontent.com/ksksrbiz-arch/ksksrbiz-arch/main/assets/repos-fm.svg?v=11" alt="Files — ~/repos: every repository auto-indexed in one file-manager window" width="100%"></a></p>
<!-- REPO-WINDOWS:END -->
...
| [walking-dead-universe-atlas](https://github.com/ksksrbiz-arch/walking-dead-universe-atlas) | Mobile-first, data-driven atlas for the Walking Dead Universe — [live site](https://walking-dead-universe-atlas.netlify.app/) |
